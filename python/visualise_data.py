...
for chan in channels:
    ...
    kg1l_lid3_RM, dummy = getdata(shot_no, dda, 'LID' + str(chan),uid='bviola',seq=432)
    kg1l_lad3_RM, dummy = getdata(shot_no, dda, 'LAD' + str(chan),uid='bviola',seq=432)
    kg1l_len3_RM, dummy = getdata(shot_no, dda, 'LEN' + str(chan),uid='bviola',seq=432)
    kg1l_xtan3_RM, dummy = getdata(shot_no, dda, 'xta' + str(chan),uid='bviola',seq=432)


    kg1l_lid3_RMP, dummy = getdata(shot_no, dda, 'LID' + str(chan),uid='bviola',seq=433)
    kg1l_lad3_RMP, dummy = getdata(shot_no, dda, 'LAD' + str(chan),uid='bviola',seq=433)
    kg1l_len3_RMP, dummy = getdata(shot_no, dda, 'LEN' + str(chan),uid='bviola',seq=433)
    kg1l_xtan3_RMP, dummy = getdata(shot_no, dda, 'xta' + str(chan),uid='bviola',seq=433)
    ...
    kg1l_xtan3_F, dummy = getdata(shot_no, dda, 'xta' + str(chan),uid='bviola',seq=434)


    ax_1 = plt.subplot(5, 1, 1)
    plt.plot(kg1v_lid3_jetppf['time'], kg1v_lid3_jetppf['data'],
             label='lid_jetppf_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_lid3_RM['time'], kg1l_lid3_RM['data'],
             label='lid_RM_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_lid3_RMP['time'], kg1l_lid3_RMP['data'],
             label='lid_RMP_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_lid3_F['time'], kg1l_lid3_F['data'],
             label='lid_F_ch' + str(chan) + '_' + str(shot_no))

    plt.legend(loc='best', prop={'size': 6}, frameon=False, ncol=2)

    plt.subplot(5, 1, 2, sharex=ax_1)
    plt.plot(kg1l_lad3_jetppf['time'], kg1l_lad3_jetppf['data'],
             label='lad_jetppf_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_lad3_RM['time'], kg1l_lad3_RM['data'],
             label='lad_RM_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_lad3_RMP['time'], kg1l_lad3_RMP['data'],
             label='lad_RMP_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_lad3_F['time'], kg1l_lad3_F['data'],
    ...
    plt.subplot(5, 1, 3, sharex=ax_1)
    plt.plot(kg1l_xtan3_jetppf['time'], kg1l_xtan3_jetppf['data'],
             label='xtan_jetppf_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_xtan3_RM['time'], kg1l_xtan3_RM['data'],
             label='xtan_RM_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_xtan3_RMP['time'], kg1l_xtan3_RMP['data'],
             label='xtan_RMP_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_xtan3_F['time'], kg1l_xtan3_F['data'],
    ...
    plt.subplot(5, 1, 4, sharex=ax_1)
    plt.plot(kg1l_len3_jetppf['time'], kg1l_len3_jetppf['data'],
             label='len_jetppf_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_len3_RM['time'], kg1l_len3_RM['data'],
             label='len_RM_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_len3_RMP['time'], kg1l_len3_RMP['data'],
             label='len_RMP_ch' + str(chan) + '_' + str(shot_no))
    plt.plot(kg1l_len3_F['time'], kg1l_len3_F['data'],
    ...
    plt.savefig(cwd + os.sep + 'figures/' + code + '_' + str(
        shot_no) + 'ch_' + str(chan) + '_comparison_algorithms.png', dpi=300)
